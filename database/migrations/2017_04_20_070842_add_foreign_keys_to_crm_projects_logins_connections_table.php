...
class AddForeignKeysToCrmProjectsLoginsConnectionsTable extends Migration {
	...
	public function up()
	{
		Schema::table('crm_projects_logins_connections', function(Blueprint $table)
		{
			...
			$table->foreign('login_id', 'fk_crm_projects_logins_connections_crm_projects_logins1')->references('id')->on('crm_projects_logins')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('crm_projects_logins_connections', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_crm_projects_logins_connections_crm_projects_logins1');
		});
	}
